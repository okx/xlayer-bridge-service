...
type BridgeServiceClient interface {
	...
	GetWstEthL2TokenNotWithdrawn(ctx context.Context, in *GetWstEthL2TokenNotWithdrawnRequest, opts ...grpc.CallOption) (*GetWstEthL2TokenNotWithdrawnResponse, error)
}
...
func (c *bridgeServiceClient) GetLargeTransactionInfos(ctx context.Context, in *LargeTxsRequest, opts ...grpc.CallOption) (*LargeTxsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/bridge.v1.BridgeService/GetLargeTransactionInfos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bridgeServiceClient) GetWstEthL2TokenNotWithdrawn(ctx context.Context, in *GetWstEthL2TokenNotWithdrawnRequest, opts ...grpc.CallOption) (*GetWstEthL2TokenNotWithdrawnResponse, error) {
	out := new(GetWstEthL2TokenNotWithdrawnResponse)
	err := c.cc.Invoke(ctx, "/bridge.v1.BridgeService/GetWstEthL2TokenNotWithdrawn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BridgeServiceServer interface {
	...
	GetWstEthL2TokenNotWithdrawn(context.Context, *GetWstEthL2TokenNotWithdrawnRequest) (*GetWstEthL2TokenNotWithdrawnResponse, error)
...
func (UnimplementedBridgeServiceServer) GetWstEthL2TokenNotWithdrawn(context.Context, *GetWstEthL2TokenNotWithdrawnRequest) (*GetWstEthL2TokenNotWithdrawnResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetWstEthL2TokenNotWithdrawn not implemented")
}
...
func _BridgeService_GetLargeTransactionInfos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bridge.v1.BridgeService/GetLargeTransactionInfos",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BridgeService_GetWstEthL2TokenNotWithdrawn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetWstEthL2TokenNotWithdrawnRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BridgeServiceServer).GetWstEthL2TokenNotWithdrawn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bridge.v1.BridgeService/GetWstEthL2TokenNotWithdrawn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BridgeServiceServer).GetWstEthL2TokenNotWithdrawn(ctx, req.(*GetWstEthL2TokenNotWithdrawnRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BridgeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetWstEthL2TokenNotWithdrawn",
			Handler:    _BridgeService_GetWstEthL2TokenNotWithdrawn_Handler,
		},
	},
