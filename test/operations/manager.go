...
func NewManager(ctx context.Context, cfg *Config) (*Manager, error) {
	...
	bService := server.NewBridgeService(cfg.BS, cfg.BT.Height, []uint{0, 1}, []*utils.Client{nil}, []*bind.TransactOpts{nil}, pgst, nil, nil, nil, rollupID)
...
func (m *Manager) SendL1Claim(ctx context.Context, deposit *pb.Deposit, smtProof, smtRollupProof [mtHeight][32]byte, globalExitRoot *etherman.GlobalExitRoot) error {
	...
	return client.SendClaimAndWait(ctx, deposit, smtProof, smtRollupProof, globalExitRoot, auth)
}
...
func (m *Manager) SendL2Claim(ctx context.Context, deposit *pb.Deposit, smtProof, smtRollupProof [mtHeight][32]byte, globalExitRoot *etherman.GlobalExitRoot) error {
	...
	err = client.SendClaimAndWait(ctx, deposit, smtProof, smtRollupProof, globalExitRoot, auth)
	return err
}
