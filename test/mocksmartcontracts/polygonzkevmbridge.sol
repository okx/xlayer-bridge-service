...
/**
 * PolygonZkEVMBridge that will be deployed on both networks Ethereum and XLayer
    ...
    IPolygonZkEVMBridge
{
     ...
     * @notice Function to activate the emergency state
     " Only can be called by the XLayer in extreme situations
     */
     ...
     * @notice Function to deactivate the emergency state
     " Only can be called by the XLayer
     */
