...
If you need account with funds you can use the [deposit script](https://github.com/okx/zkevm-bridge-service/blob/develop/test/scripts/deposit/main.go)
to fund an account.
For a list with accounts that already have ETH check out [node's docs](https://github.com/okx/zkevm-node/blob/develop/docs/running_local.md#accounts).
